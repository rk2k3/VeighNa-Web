...
for filepath, replacements in patches:
    ...
    for old, new in replacements:
        if old in content:
            ...
            print(f"Applied patch in: {filepath}")
        else:
            print(f"WARNING: patch not found in {filepath} - may already be applied or file differs")

"""Persistence for saved portfolio strategies.

A saved portfolio strategy is a questionnaire/AI result: a named, reusable
configuration that *links* to one of the allocation algorithms in the top-level
``strategies/portfolio/`` folder via its ``strategy`` field (the strategy module
name) and carries the concrete universe, capital, and parameters. Its
single-stock counterpart is saved_stock_service.
